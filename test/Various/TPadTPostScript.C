...
void plotRMqa(int runno)
{
  ...
  TH1F* ledchg0 = (TH1F*)myfile->Get("FED_700/Spigot 00/LED Plots/QIEsSumLED_S00");
  TH1F* ledtime0 = (TH1F*)myfile->Get("FED_700/Spigot 00/LED Plots/LED timing mean of spigot 00");
  TH1F* pedavg0 = (TH1F*)myfile->Get("FED_700/Spigot 00/Pedestal Plots/Pedestal mean of spigot 00");
  TH1F* pedrms0 = (TH1F*)myfile->Get("FED_700/Spigot 00/Pedestal Plots/Pedestal RMS of spigot 00");

  TH1F* ledchg1 = (TH1F*)myfile->Get("FED_700/Spigot 01/LED Plots/QIEsSumLED_S01");
  TH1F* ledtime1 = (TH1F*)myfile->Get("FED_700/Spigot 01/LED Plots/LED timing mean of spigot 01");
  TH1F* pedavg1 = (TH1F*)myfile->Get("FED_700/Spigot 01/Pedestal Plots/Pedestal mean of spigot 01");
  TH1F* pedrms1 = (TH1F*)myfile->Get("FED_700/Spigot 01/Pedestal Plots/Pedestal RMS of spigot 01");

  TH1F* ledchg2 = (TH1F*)myfile->Get("FED_700/Spigot 02/LED Plots/QIEsSumLED_S02");
  TH1F* ledtime2 = (TH1F*)myfile->Get("FED_700/Spigot 02/LED Plots/LED timing mean of spigot 02");
  TH1F* pedavg2 = (TH1F*)myfile->Get("FED_700/Spigot 02/Pedestal Plots/Pedestal mean of spigot 02");
  TH1F* pedrms2 = (TH1F*)myfile->Get("FED_700/Spigot 02/Pedestal Plots/Pedestal RMS of spigot 02");

  TH1F* ledchg3 = (TH1F*)myfile->Get("FED_700/Spigot 03/LED Plots/QIEsSumLED_S03");
  TH1F* ledtime3 = (TH1F*)myfile->Get("FED_700/Spigot 03/LED Plots/LED timing mean of spigot 03");
  TH1F* pedavg3 = (TH1F*)myfile->Get("FED_700/Spigot 03/Pedestal Plots/Pedestal mean of spigot 03");
  TH1F* pedrms3 = (TH1F*)myfile->Get("FED_700/Spigot 03/Pedestal Plots/Pedestal RMS of spigot 03");
  ...
  TPaveLabel *title0 = new TPaveLabel(0.199115,0.280488,0.79941,0.841463,thisRM0.c_str());
  TPaveLabel *title1 = new TPaveLabel(0.199115,0.280488,0.79941,0.841463,thisRM1.c_str());
  TPaveLabel *title2 = new TPaveLabel(0.199115,0.280488,0.79941,0.841463,thisRM2.c_str());
  TPaveLabel *title3 = new TPaveLabel(0.199115,0.280488,0.79941,0.841463,thisRM3.c_str());

  TPostScript *ps = new TPostScript("RMqa.ps");
